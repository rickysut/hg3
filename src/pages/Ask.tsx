        ...
        <div className="flex items-center justify-center px-2 py-4 pt-5 bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="flex-1 flex items-center justify-center px-4 overflow-hidden">
                <div className="w-full max-w-lg">
                    <div className="p-3 mb-3 bg-white rounded-lg shadow">
                        <ul className="space-y-1 text-base font-medium text-gray-800">
                            <li>• Apa yang anda sukai dan membuat anda bertumbuh di pelayanan HG3 Jam 11.00?</li>
                            <li>• Ada saran atau masukkan untuk perbaikan pelayanan HG3 jam 11.00?</li>
                            <li>• Ada pertanyaan lain yg ingin disampaikan?</li>
                        </ul>
                    </div>
                    
                    <form onSubmit={submitForm} className="space-y-3">
                        <div>
                            <label htmlFor="question" className="block mb-1 text-base font-medium text-gray-700">
